...
router.get('/accountinfo', passportConfig.isAuthenticated, userController.getAccountInfo);
...
router.get('/auth/facebook/callback', passport.authenticate('facebook', { failureRedirect: angularUrl+'login' }), (req, res) => {
