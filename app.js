...
app.get('/log', userController.getLog);
...
app.get('/account', passportConfig.isAuthenticated, userController.getAccountInfo);
app.get('/accountinfo', passportConfig.isAuthenticated, userController.getAccountInfo);
